---
title: "RMedlineFunctions Examples 'librarian'"
...
This example uses 'librarian' as a search query. There is a fair amount of research on Myasthenia Gravis, so some parts of the script, such as adding data about citations, can take a long time to complete. 
